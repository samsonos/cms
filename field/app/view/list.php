            ...
            <?php else:?>
                <?php foreach ($items as $db_field):?>
                    <li title="<?php echo $db_field->Description; ?>">
                        ...
                        <a class="icon2 icon_16x16 icon-edit edit-field-button" href="field/form/<?php echo $db_structure->id ?>/<?php echo $db_field->id; ?>" title="Редактировать поле элемента структуры сайта"></a>
                        <a class="icon2 icon_16x16 icon-delete delete-field-button" href="field/delete/<?php echo $db_structure->id ?>/<?php echo $db_field->id; ?>" title="Удалить поле элемента структуры сайта"></a>
                    </li>
                <?php endforeach?>
            <?php endif ?>
        </ul>
