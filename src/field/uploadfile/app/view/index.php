<div class="__inputfield __container __fieldUpload <?php v('emptyclass')?>" >
    ...
    <p class="__progress_text" style="display:none">0%</p>
	<div class="__progress_bar"><p></p></div>
	<a  href="<?php v('delete_controller')?>" class="__deletefield icon2 icon_16x16 icon-delete delete" title="Удалить файл" <?php if (!isv('field_value')):?>style="display:none"<?php endif;?>></a>
