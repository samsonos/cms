...
<form method="post" class="form2" action="user/ajax_save/<?php v('user_id'); ?>" >
	...
	<?php if( ! isset( $db_user ) ):?>		  
		<div class="header">Создание пользователя</div>		
	<?php else:?>
		<div class="header">Редактирование пользователя <span class="bold"><?php echo mdl_user_short_name( $db_user ); ?></span></div>
	<?php endif?>		 
	<ul class="table-like-list">
		<li><label>Имя:</label><div class="input-text"><input name="FName" id="FName" value="<?php v('user_FName'); ?>"></div></li>
		<li><label>Фамилия:</label><div class="input-text"><input name="SName" id="SName" value="<?php v('user_SName'); ?>"></div></li>
		<li><label>Отчество:</label><div class="input-text"><input name="TName" id="TName" value="<?php v('user_TName'); ?>"></div></li>
	...
	<?php if( ! isset( $db_user ) ):?>
		<li title="Добавить нового пользователя" class="right-align"><input type="submit" value="Добавить" class=""></li>
	<?php else:?>
		<li title="Сохранить данные пользователя" class="right-align"><input type="submit" value="Сохранить" class=""></li>
	<?php endif?>	
	</ul>
</form>
